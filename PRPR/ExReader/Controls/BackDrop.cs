...
namespace PRPR.ExReader.Controls
{
    public class BackDrop : Control
    {
        ...
        public static readonly DependencyProperty BlurAmountDependencyProperty =
            DependencyProperty.Register("BlurAmount", typeof(UIElement), typeof(BackDrop), new PropertyMetadata(0));
