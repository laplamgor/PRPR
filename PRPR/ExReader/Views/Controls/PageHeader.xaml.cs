...
namespace PRPR.ExReader.Views.Controls
{
    public sealed partial class PageHeader : UserControl
    {
        public PageHeader()
        {
            ...
            this.Loaded += (s, a) =>
            {
                this.titleBar.Margin = new Thickness(AppShell.Current.TogglePaneButtonRect.Right - AppShell.Current.TogglePaneButtonRect.Left, 0, 0, 0);
            };
        }

        private void Current_TogglePaneButtonSizeChanged(AppShell sender, Rect e)
        {
            this.titleBar.Margin = new Thickness(e.Right - e.Left, 0, 0, 0);
        }
        ...
        public UIElement HeaderContent
        {
            get
            {
                return (UIElement)GetValue(HeaderContentProperty);
            }
            set
            {
